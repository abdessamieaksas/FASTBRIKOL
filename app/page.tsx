              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    FASTBRIKOL connects you with verified local professionals for all your home repair and maintenance
                    needs.
          ...
          <div className="container px-4 md:px-6 relative">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1">
                ...
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl mb-6">How FASTBRIKOL Works</h2>
        ...
        <section id="why-choose-us" className="w-full py-16 md:py-24 lg:py-32 bg-white relative">
          ...
          <div className="container px-4 md:px-6 relative">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              ...
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Why Choose FASTBRIKOL</h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl">
            ...
            <div className="mt-16 flex flex-col items-center justify-center rounded-xl bg-blue-50 p-8 text-center">
              <h3 className="mb-4 text-2xl font-bold">Ready to experience the FASTBRIKOL difference?</h3>
              ...
              {[
                {
                  ...
                  comment:
                    "FASTBRIKOL saved me when my pipe burst in the middle of the night. The plumber arrived within an hour and fixed everything quickly! I couldn't be more grateful for the prompt and professional service.",
                },
                {
                  name: "Michael Chen",
                  ...
                  comment:
                    "I've used FASTBRIKOL for electrical and painting services. Both professionals were punctual, skilled, and left my place spotless. The pricing was transparent and fair. I'll definitely use FASTBRIKOL again!",
                },
                {
                  ...
                  comment:
                    "As a property manager, I rely on FASTBRIKOL to handle maintenance requests. Their service is consistently excellent and reliable. The platform makes it easy to track jobs and communicate with professionals.",
                },
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="flex flex-col space-y-6 text-white">
                ...
                <p className="text-lg md:text-xl text-blue-100">
                  Join thousands of satisfied customers who trust FASTBRIKOL for their home service needs. Get started in
                  minutes.
                </p>
                ...
                <div className="flex items-center gap-4 mt-4">
                  ...
                  <p className="text-sm text-blue-100">Join 10,000+ homeowners using FASTBRIKOL today</p>
                </div>
              </div>
