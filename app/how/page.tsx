    ...
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
      <div className="grid grid-cols-3">
        ...
        <div className="border-b border-r border-gray-200 bg-blue-50 p-6 text-center">
          <h3 className="text-lg font-medium text-blue-600">FASTBRIKOL</h3>
        </div>
    ...
    <NavBar />
        ...
        <div className="relative">
          <AnimatedSection className="container flex min-h-[80vh] flex-col items-center justify-center px-4 py-20 text-center">
            ...
            <motion.p variants={fadeInUp} className="mb-8 max-w-2xl text-xl text-muted-foreground">
              Découvrez comment FASTBRIKOL connecte les artisans qualifiés avec les personnes qui ont besoin de
      ...
      <AnimatedSection className="container px-4 py-16">
        <motion.div variants={fadeInUp} className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
            Découvrez les avantages de FASTBRIKOL par rapport aux méthodes traditionnelles.
          </p>
        </motion.div>
      ...
      {/* <AnimatedSection className="container px-4 py-24">
        <motion.div variants={fadeInUp} className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
            FASTBRIKOL offre de nombreux avantages tant pour les clients que pour les artisans.
          </p>
        </motion.div>
        ...
        <div className="container px-4">
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            <motion.div variants={slideInLeft}>
              ...
              <h2 className="mb-4 text-3xl font-bold sm:text-4xl">Emportez FASTBRIKOL Partout</h2>
