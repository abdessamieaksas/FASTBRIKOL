        ...
        <div className="relative">
          <AnimatedSection className="container flex min-h-screen flex-col items-center justify-center px-4 py-20 text-center">
            ...
            <motion.p variants={fadeInUp} className="mb-8 max-w-2xl text-xl text-muted-foreground">
              FASTBRIKOL connects skilled local professionals with people who need their services, creating
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="mb-4 text-muted-foreground">
                    FASTBRIKOL a été créé avec une mission claire : connecter les artisans locaux talentueux
