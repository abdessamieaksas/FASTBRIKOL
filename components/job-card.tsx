...
import { Calendar, Clock, MapPin, Star, Bookmark, Briefcase, Sparkles, Sprout, Wrench, Zap, Baby, Package, ChefHat, Dog, BookOpen, Hammer } from "lucide-react"
...
const CategoryIcon = ({ category }: { category: string }) => {
  ...
  if (cat.includes("clean")) return <Sparkles className="h-6 w-6" />;
  if (cat.includes("garden") || cat.includes("landscape")) return <Sprout className="h-6 w-6" />;
  if (cat.includes("plumb")) return <Wrench className="h-6 w-6" />;
  if (cat.includes("electr")) return <Zap className="h-6 w-6" />;
  if (cat.includes("child")) return <Baby className="h-6 w-6" />;
  if (cat.includes("mov")) return <Package className="h-6 w-6" />;
  if (cat.includes("cook")) return <ChefHat className="h-6 w-6" />;
  if (cat.includes("pet")) return <Dog className="h-6 w-6" />;
  if (cat.includes("tutor") || cat.includes("math")) return <BookOpen className="h-6 w-6" />;
  if (cat.includes("handyman") || cat.includes("repair") || cat.includes("carpent")) return <Hammer className="h-6 w-6" />;
