...
export default function RegisterPage() {
  ...
  const getPasswordStrength = (password: string) => {
    ...
    else if (password.length < 12) return { strength: 2, text: "Medium" }
    else return { strength: 3, text: "Strong" }
  }
      ...
      <main className="flex flex-1 items-center justify-center bg-gray-50 py-12">
        <div className="mx-auto w-full max-w-md space-y-6 px-4">
          <div className="flex flex-col items-center space-y-2 text-center">
            ...
            <h1 className="text-2xl font-bold">Create your FASTBRIKOL account</h1>
